...
const Index = () => {
  ...
  const handleAddZone = (name: string) => {
    if (!currentUser || currentUser.role !== 'admin') {
      toast({
        ...
        description: "Only administrators can add new cities",
        variant: "destructive",
      });
      return;
    }
  ...
  const handleStatusChange = (id: number, status: string) => {
    ...
    if (currentUser.role !== 'admin' && zone?.concernId !== currentUser.concernId) {
      toast({
        title: "Permission denied",
        description: "You can only update your assigned city",
        variant: "destructive",
      });
      return;
    }
